# Generated by Django 2.1.5 on 2022-03-06 21:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('review_number', models.PositiveSmallIntegerField(choices=[(1, '1 - Do not Recomment'), (2, '2 - Bad'), (3, '3 - Reccomendable'), (4, '4 - Very Good'), (5, '5 - Master Piece')])),
                ('movie_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movieworld.Movies')),
